...
public class two_queuesMain {

    private static final List<String> NAMES = List.of(
            "Саша", "Петя", "Вася", "Дуняша", "Алевтина",
            "Костя", "Валерий", "Андрон", "Михей", "Тутси");
    ...
    public static void add(String name, Queue<String> queue1,
                           Queue<String> queue2) {
